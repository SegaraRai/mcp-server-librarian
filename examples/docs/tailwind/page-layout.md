  ...
  <div class="w-full md:w-64 bg-gray-100 p-4">
    <nav>
      <ul>
        ...
        <li class="mb-2">
          <a href="#" class="block p-2 hover:bg-gray-200 rounded">About</a>
        </li>
        <li class="mb-2">
          <a href="#" class="block p-2 hover:bg-gray-200 rounded">Services</a>
        </li>
        <li class="mb-2">
          <a href="#" class="block p-2 hover:bg-gray-200 rounded">Contact</a>
        </li>
      </ul>
    </nav>
  </div>
  ...
  <div class="flex-1 flex flex-col md:flex-row">
    ...
    <nav class="w-full md:w-64 bg-gray-100 p-4">
      ...
      <ul>
        ...
        <li class="mb-2">
          <a href="#" class="block p-2 hover:bg-gray-200 rounded">Link 3</a>
        </li>
      </ul>
    </nav>
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
      ...
      <div class="p-4">
        ...
        <p class="text-gray-700 mb-2">
          This is a description for the card content that might span multiple
          lines.
        </p>
        <button
...
<div class="relative bg-gray-900 text-white">
  ...
  <!-- Content -->
  <div
    class="relative max-w-7xl mx-auto px-4 py-24 sm:px-6 lg:px-8 flex flex-col items-center text-center"
  >
    <h1 class="text-4xl sm:text-5xl md:text-6xl font-extrabold mb-4">
      Welcome to Our Site
    </h1>
    <p class="text-xl max-w-3xl mb-8">
      A brief description of your company or the purpose of the website goes
      here. Make it compelling and concise.
    </p>
    <div class="flex flex-col sm:flex-row gap-4">
      <a
        href="#"
        class="px-8 py-3 bg-blue-600 text-white font-medium rounded-md hover:bg-blue-700"
        >Get Started</a
      >
      <a
        href="#"
        class="px-8 py-3 bg-white text-blue-900 font-medium rounded-md hover:bg-gray-100"
        >Learn More</a
      >
    </div>
  </div>
...
<div class="min-h-screen bg-gray-100">
  <!-- Sidebar -->
  <aside
    class="fixed inset-y-0 left-0 w-64 bg-gray-800 text-white overflow-y-auto"
  >
    <div class="p-4">
