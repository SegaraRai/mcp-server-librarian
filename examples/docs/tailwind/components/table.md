...
<table class="min-w-full border-collapse border border-gray-200">
  <thead>
    <tr>
      <th
        class="border border-gray-200 px-6 py-3 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"
      >
        Name
      </th>
      <th
  ...
  <tbody>
    <tr>
      <td class="border border-gray-200 px-6 py-4 whitespace-nowrap">
        John Doe
      </td>
      <td class="border border-gray-200 px-6 py-4 whitespace-nowrap">
        john@example.com
